...
class ReportWriter:
    ...
    def write(cl, il, mr = False):
        ...
        f.write('<td class="pl"><h1>Netmonitor Snapshot Report</h1><p class="mt">Autonomous network monitoring reports for TCP/UDP connections active on the (NIC) network interface card.</p></td>')
        f.write("</tr>")
        f.write("</table>")
        f.write("<br />")
